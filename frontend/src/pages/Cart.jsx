...
import { useOrderMutation } from "../redux/features/order/orderApiSlice";
...
const Cart = () => {
    ...
    const handlePayment = async () => {
        const stripePromise = await loadStripe(import.meta.env.VITE_APP_PUBLISH_KEY);
        const { data } = await order({ cartItems: cart })
                ...
                <div className="px-10 py-6 flex gap-10 bg-gray-50">
                    ...
                    <div className="min-w-[450px]">
                        <div className="flex flex-col rounded-md overflow-hidden">
                            ...
                            <button onClick={handlePayment} className="bg-blue-500 text-white py-2 px-3 font-semibold">Payment</button>
                        </div>
                    </div>
                </div>
            }
