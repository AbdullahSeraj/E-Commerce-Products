        ...
        <div className='flex flex-col md:flex-row'>
            <div className='admin-profile bg-white w-full md:w-[350px] text-center p-6'>
                ...
                <div className='mt-2 md:mt-10'>
                    <div className='text-start mb-2'><NavLink className={"underline"} to="/admin-panel">All Users</NavLink></div>
                    <div className='text-start mb-2'><NavLink className={"underline"} to='/admin-panel/products'>All Products</NavLink></div>
                    <div className='text-start'><NavLink className={"underline"} to='/admin-panel/orders'>All Orders</NavLink></div>
                </div>
            </div>

            <div className='w-full overflow-auto min-h-[calc(100vh-110px)] md:h-[calc(100vh-110px)]'>
                <Outlet />
            </div>
        </div>
    )
