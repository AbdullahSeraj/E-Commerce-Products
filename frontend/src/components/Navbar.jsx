        ...
        <div className='fixed top-0 left-0 right-0 flex justify-between items-center gap-3 h-[60px] shadow-lg px-7 bg-white z-50'>
            ...
            <div className='flex items-center gap-4'>
                {accessToken && <div className="relative">
                    ...
                    {showMenu && <div className="absolute -bottom-3 translate-y-full left-1/2 -translate-x-1/2 bg-white rounded-md p-2 w-[110px]">
                        ...
                        <Link to={"/order"} onClick={() => setShowMenu(false)} className='block my-[3px] hover:bg-gray-50 rounded-md cursor-pointer py-1 px-3 text-xs text-center'>Orders</Link>
                        {getUser?.role &&
